...
//    public static String MPA_SÖ_211006_1 = "MPA_SÖ_211006_1";
//    public static String MPA_SÖ_211006_2 = "MPA_SÖ_211006_2";
...
//    public static String RBC_Exempel_3 = "RBC_Exempel_3";
    ...
    public static String AUDIT_JW3 = "AUDIT_JW3";
    public static String AUDIT_JW4 = "AUDIT_JW4";
    public static String AUDIT_JW5 = "AUDIT_JW5";
...
//        name2Ids.put(MPA_SÖ_211006_1, new ClinicalTrialIds("MPA_SÖ_211006_to test haow documentURL", "2021-500994-17-00", "1329"));
//        name2Ids.put(MPA_SÖ_211006_2, new ClinicalTrialIds("MPA_SÖ_211006_to test haow documentURL", "2021-501000-14-00", "1335"));
...
//        name2Ids.put(RBC_Exempel_3, new ClinicalTrialIds(RBC_Exempel_3, "2021-501202-38-00", "1811"));
        name2Ids.put(AUDIT_JW3, new ClinicalTrialIds(AUDIT_JW3, "2021-500415-37-00", "528", "928"));
        name2Ids.put(AUDIT_JW4, new ClinicalTrialIds(AUDIT_JW4, "2021-500523-50-00", "643", "1106"));
        name2Ids.put(AUDIT_JW5, new ClinicalTrialIds(AUDIT_JW5, "2021-500738-24-00", "528", "1467"));
