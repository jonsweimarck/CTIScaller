...
public record DocumentMetaData(String documentUrl,
                               String displayName,
                               String documentId,
                               String title,
                               ...
                               String section) implements Comparable {
